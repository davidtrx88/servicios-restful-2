...
import servicios.Contacto;
import servicios.ContactoPK;
...
public class ContactoFacadeREST extends AbstractFacade<Contacto> {
    ...
    private ContactoPK getPrimaryKey(PathSegment pathSegment) {
         ...
         */
        servicios.ContactoPK key = new servicios.ContactoPK();
    ...
    public void remove(@PathParam("id") PathSegment id) {
        servicios.ContactoPK key = getPrimaryKey(id);
